      ...
      <motion.div variants={itemVariants}>
        <div className="bg-card rounded-2xl border border-border shadow-soft overflow-hidden">
          <div className="h-32 bg-primary relative overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-br from-primary/80 to-primary opacity-100" />
          </div>
          <div className="px-6 pb-6">
            <div className="relative flex flex-col sm:flex-row sm:items-end -mt-12 mb-4 gap-4">
              {/* Avatar */}
              <div className="relative">
                <div className="w-24 h-24 bg-card rounded-2xl shadow-lg flex items-center justify-center border-4 border-card">
                  <span className="text-3xl font-bold text-foreground">
                    {perfilData.nombres[0]}{perfilData.apellidos[0]}
                  </span>
                </div>
                <button className="absolute bottom-0 right-0 w-8 h-8 bg-foreground text-background rounded-lg flex items-center justify-center shadow-lg hover:bg-foreground/90 transition-colors">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      disabled={!editMode}
                      className={`pl-10 ${!editMode ? 'bg-muted' : ''}`}
                    />
                  </div>
                </div>
                <div className="space-y-2">
