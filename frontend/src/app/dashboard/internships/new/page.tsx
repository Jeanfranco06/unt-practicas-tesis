...
export default function NewInternshipPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Nueva Oferta</h1>
        <p className="text-muted-foreground text-sm mt-1">Registra una nueva oferta de práctica preprofesional</p>
      </div>
      <OfferForm
        title="Nueva Oferta"
